# Ada - Week 0
# Data Transformation Worksheet with Colorize Gem
...
puts "String lengths: #{word_lengths}".colorize(:red)
...
puts "String lengths: #{enum_string_lengths(my_strings)}".colorize(:red)
...
puts "\nEven or odd: #{num_results}".colorize(:yellow)
...
puts "Even or odd: #{enum_even_or_odd(my_nums)}".colorize(:yellow)
...
puts "\nShort strings: #{short_words}".colorize(:green)
...
puts "Short strings: #{enum_short_strings(my_strings)}".colorize(:green)
...
puts "\nLongest string: #{longest_word}".colorize(:blue)
...
puts "Longest string: #{enum_longest_string(my_strings)}".colorize(:blue)
...
puts "\nDwarfs and ids: #{dwarf_ids}".colorize(:magenta)
...
puts "\nDwarfs, specialties, and ids: #{dwarfs_with_specialties_ids}".colorize(:cyan)
